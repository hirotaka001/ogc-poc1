...
```
```bash
mac:$ env ROBOT_SERVICE="robot" ROBOT_SERVICEPATH="/" ROBOT_TYPE="guide_robot" ROBOT_ID="guide_robot" TURTLEBOT_1_ID="1" DEST_LED_SERVICE="dest_led" DEST_LED_SERVICEPATH="/" DEST_LED_TYPE="dest_led" envsubst < controller/guidance.yaml | kubectl apply -f -
```
```bash
